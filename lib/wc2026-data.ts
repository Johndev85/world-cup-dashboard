...
export const PHASE_COLORS: Record<string, string> = {
  "Grupo A": "bg-blue-500/15 text-blue-700 dark:text-blue-300",
  "Grupo B": "bg-purple-500/15 text-purple-700 dark:text-purple-300",
  "Grupo C": "bg-emerald-500/15 text-emerald-700 dark:text-emerald-300",
  "Grupo D": "bg-yellow-500/15 text-yellow-700 dark:text-yellow-300",
  "Grupo E": "bg-pink-500/15 text-pink-700 dark:text-pink-300",
  "Grupo F": "bg-orange-500/15 text-orange-700 dark:text-orange-300",
  "Grupo G": "bg-teal-500/15 text-teal-700 dark:text-teal-300",
  "Grupo H": "bg-red-500/15 text-red-700 dark:text-red-300",
  "Grupo I": "bg-indigo-500/15 text-indigo-700 dark:text-indigo-300",
  "Grupo J": "bg-cyan-500/15 text-cyan-700 dark:text-cyan-300",
  "Grupo K": "bg-lime-500/15 text-lime-700 dark:text-lime-300",
  "Grupo L": "bg-rose-500/15 text-rose-700 dark:text-rose-300",
  "Octavos de Final":  "bg-amber-500/15 text-amber-700 dark:text-amber-300",
  "Cuartos de Final":  "bg-amber-500/15 text-amber-700 dark:text-amber-300",
  "Semifinal":         "bg-amber-600/15 text-amber-800 dark:text-amber-200",
  "Semifinales":       "bg-amber-600/15 text-amber-800 dark:text-amber-200",
  "Tercer Lugar":      "bg-amber-700/15 text-amber-900 dark:text-amber-200",
  "Final":             "bg-primary/15 text-green-700 dark:text-primary",
}
